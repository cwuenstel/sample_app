...
describe User do
  ...
  describe "password validations" do
    ...
    it "should require a password", :chapter6 => "true" do
      User.new(@attr.merge(:password => "", :password_confirmation => "")).
        should_not be_valid
    end

    it "should require a matching password confirmation", :chapter6 => "true" do
      User.new(@attr.merge(:password_confirmation => "invalid")).
        should_not be_valid
    end

    it "should reject short passwords", :chapter6 => "true" do
      short = "a" * 5
      hash = @attr.merge(:password => short, :password_confirmation => short)
      User.new(hash).should_not be_valid
    end

    it "should reject long passwords", :chapter6 => "true" do
      long = "a" * 41
  ...
  describe "password encryption" do
    ...
    it "should have an encrypted password attribute", :chapter6 => "true" do
